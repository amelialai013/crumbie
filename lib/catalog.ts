...
export const products: Product[] = [
  { id:"product-signature", slug:"signature-box", name:"Signature Crumbie", description:"A thick chocolate chip cookie with crisp, golden edges and a soft, tender centre, packed with generous chunks of rich chocolate in every bite.", ingredients:"Pickup dates close 72 hours before their scheduled start time, orders can be placed up until this time. Pickup is in Ivanhoe, Victoria. Exact address provided in your confirmation email after purchase.", allergens:"Contains gluten, dairy, eggs and soy. Made in a kitchen that handles peanuts and tree nuts; cross-contact is possible.", images:["https://images.unsplash.com/photo-1499636136210-6f4ee915583e?auto=format&fit=crop&w=1400&q=88","https://images.unsplash.com/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&w=1400&q=88"], variants:[{id:"signature-6",label:"Box of 6",quantity:6,price:30},{id:"signature-12",label:"Box of 12",quantity:12,price:55}] },
